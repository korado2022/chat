...
from config import MESSAGE_TEXT, SENDER
...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        self.ui.btn_send.clicked.connect(self.send_message_main)
    ...
    def send_message_main(self):
        ...
        try:
            self.transport.send_message_client(self.current_chat, message_text_encrypted_base64.decode('ascii'))
            pass
        except ServerError as err:
